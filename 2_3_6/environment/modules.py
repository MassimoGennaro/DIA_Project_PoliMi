...
from environment.learner import * 
...
class Context_Manager():
    def __init__(self, n_arms, feature_space, candidates, week = -1):
        ...
        self.features_context = {("y", "f"):0, ("a", "f"):1, ("y", "u"):2}
...
class General():
    ...
    def play_experiment(self, num_persons):
        for t in range(num_persons):
            ...
            pulled_arm = self.context_manager.select_arm(features_person, t, self.candidates_values)
